...
- **后续**：4B（Structured Analysts；4B.1 Business / Event / Risk Claim Analysis）= next；4C（Financial / Macro 专项分析）= later；4D（Claim 综合 / 冲突 / 证据缺口）= later；**Report 生成与 Agent Audit 属于 Stage 5**，不提前标记。详见 [docs/stage-4-plan.md](docs/stage-4-plan.md)。
